...
A [timoni.sh](http://timoni.sh) module for deploying web to Kubernetes clusters.
...
```shell
timoni -n default apply web oci://<container-registry-url>
```
