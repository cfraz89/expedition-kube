...
A [timoni.sh](http://timoni.sh) module for deploying kratos to Kubernetes clusters.
...
```shell
timoni -n default apply kratos oci://<container-registry-url>
```
...
```shell
timoni -n default delete kratos
```
